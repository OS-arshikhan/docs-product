...
<warning >To have the IT Users Authentication with External IdP (OIDC) feature available, ALL the environments registered in LifeTime and Factory Configuration should meet the requirements
